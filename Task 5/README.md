# Thiranex StyleStore — E-Commerce Capstone

A production-ready e-commerce product catalog built with Vite and modern web development practices.

Live Demo: [https://thiranex-stylestore.vercel.app/](https://thiranex-stylestore.vercel.app/)

## Features
* **Modular Architecture** — Separated components, pages, state, and utilities
...
* **Product Catalog** — Products across multiple categories with search and filter functionality
...
3. Vercel auto-detects Vite — select Vite as the framework preset and click Deploy
4. `vercel.json` (if present) handles SPA routing automatically
...
* React / Vanilla JavaScript (ES Modules)
* CSS3 / Tailwind CSS — Custom properties, Grid, Flexbox
* History API / React Router — Client-side routing without a framework
